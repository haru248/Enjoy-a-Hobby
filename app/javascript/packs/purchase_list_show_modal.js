window.addEventListener('load', function() {
  if(!localStorage.getItem('LIVE_Pl@nning_purchase_list_modal_first_display_on_or_not')) {
    localStorage.setItem('LIVE_Pl@nning_purchase_list_modal_first_display_on_or_not', 'on');
